...
export function Sidebar() {
  ...
  return (
    <div className="hidden md:flex fixed top-0 left-0 bottom-0 w-64 z-40">
      <div className="flex flex-col w-full h-full border-r border-gray-200 bg-white dark:bg-gray-800 overflow-y-auto">
