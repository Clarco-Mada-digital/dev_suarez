    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">À Propos de Notre Entreprise</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400">Innovation, Excellence et Engagement</p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-400 space-y-2 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-200">Notre Mission</h3>
            <p className="text-gray-600 dark:text-gray-400">Fournir des solutions innovantes qui transforment les défis en opportunités pour nos clients.</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-200">Notre Vision</h3>
            <p className="text-gray-600 dark:text-gray-400">Être reconnu comme un leader dans notre domaine grâce à l'innovation et l'excellence opérationnelle.</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="font-semibold text-lg mb-2 text-gray-800 dark:text-gray-200">Nos Valeurs</h3>
            <p className="text-gray-600 dark:text-gray-400">Intégrité, Innovation, Excellence et Engagement envers nos clients et partenaires.</p>
          </div>
        </div>
